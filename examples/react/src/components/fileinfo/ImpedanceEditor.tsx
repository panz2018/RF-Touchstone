...
const ImpedanceEditor: React.FC<ImpedanceEditorProps> = ({ currentImpedance, onImpedanceChange }) => {
  ...
  const [editableImpedanceStr, setEditableImpedanceStr] = useState<string>(impedanceToString(currentImpedance));
  ...
  const handleImpedanceBlur = () => {
    ...
    if (impedanceToString(newImpedance) !== impedanceToString(currentImpedance)) {
