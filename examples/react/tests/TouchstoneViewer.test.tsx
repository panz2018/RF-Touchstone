  ...
  ts.networkData = [
    {
      ...
      parameters: [
        [
          { magnitude: 0.1, angle: -10 },
          { magnitude: 0.2, angle: -20 },
        ],
        [
          { magnitude: 0.3, angle: -30 },
          { magnitude: 0.4, angle: -40 },
        ],
      ],
    },
    {
      ...
      parameters: [
        [
          { magnitude: 0.5, angle: -50 },
          { magnitude: 0.6, angle: -60 },
        ],
        [
          { magnitude: 0.7, angle: -70 },
          { magnitude: 0.8, angle: -80 },
        ],
      ],
    },
  ]
